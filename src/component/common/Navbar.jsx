...
function Navbar() {
    ...
    return (
        <nav className="navbar">
            ...
            <NavLink to="/home">
  <img src="/assets/images/Vin.svg" alt="Phegon Hotel Logo" className="logo-img" />
</NavLink>
            ...
            <ul className="navbar-ul">
                ...
                {!isAuthenticated &&<li><NavLink to="/register" activeclassname="active">Registerr</NavLink></li>}
