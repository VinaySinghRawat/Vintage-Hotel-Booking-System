...
const HomePage = () => {
    ...
    <source src="./assets/images/vin2.mp4" type="video/mp4" />
    Your browser does not support the video tag.
  </video>
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">Vintage Hotel</span>
                        </h1><br />
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Vintage Hotel</span></h2>
